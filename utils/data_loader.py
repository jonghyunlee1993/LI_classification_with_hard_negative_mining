    ...
    def define_augmentation(self):
        self.train_transform = A.Compose(
            [
                ...
                A.OneOf([A.Transpose(), A.HorizontalFlip(), A.VerticalFlip()], p=0.5),
                A.OneOf(
                    [
                        A.ElasticTransform(),
                        A.Rotate(25),
                ...
                A.OneOf(
                    [A.Blur(), A.GaussianBlur(), A.GaussNoise(), A.MedianBlur()], p=0.2
                ),
        ...
        self.valid_transform = A.Compose(
            [A.Resize(width=224, height=224, p=1.0), A.Normalize(p=1.0), ToTensorV2()]
        )
